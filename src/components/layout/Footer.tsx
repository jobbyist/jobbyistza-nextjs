            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative">
                  <a 
                    href="#" 
                    className="inline-flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 rounded-lg transition-colors border border-white/30 focus-ring"
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-xs text-white/80">Coming Soon to</div>
                ...
                {links.map((link) => (
                  <li key={link.name}>
                    {link.href.startsWith('#') ? (
                      <a
                        href={link.href}
                        className="text-sm text-white/85 hover:text-white transition-colors focus-ring rounded-sm"
                      >
                        {link.name}
                      </a>
                    ) : (
