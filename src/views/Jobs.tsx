          ...
          {!loading && jobs.length > 0 && (
            <div className="mt-12 flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                {hasPrevPage && (
                  <>
                    <Link href={getPageUrl(1)} className="inline-flex">
                      <Button variant="outline" size="sm">
                        First
                      </Button>
                    </Link>
                    <Link href={getPageUrl(currentPage - 1)} className="inline-flex">
                      <Button variant="outline" size="sm">
                ...
                <div className="flex items-center gap-2 mx-2">
                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <Link key={pageNum} href={getPageUrl(pageNum)} className="inline-flex">
                        <Button
                ...
                {hasNextPage && (
                  <>
                    ...
                    <Link href={getPageUrl(totalPages)} className="inline-flex">
                      <Button variant="outline" size="sm">
                        Last
                      </Button>
                    </Link>
