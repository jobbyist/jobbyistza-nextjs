...
const sprintServiceHandbookUrl = "/sprint-service-handbook.pdf";
...
const BUSINESS_CONFIG = {
  whatsappNumber: (process.env.NEXT_PUBLIC_BUSINESS_WHATSAPP_NUMBER || "").replace(/\D/g, ""),
};

const CHECKOUT_LINKS: Record<CheckoutKey, string> = {
  lite: process.env.NEXT_PUBLIC_JOB_SPRINT_CHECKOUT_LITE || "#",
  guided: process.env.NEXT_PUBLIC_JOB_SPRINT_CHECKOUT_GUIDED || "#",
  premium: process.env.NEXT_PUBLIC_JOB_SPRINT_CHECKOUT_PREMIUM || "#",
};
