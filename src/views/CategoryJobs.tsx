...
const CategoryJobs = () => {
  ...
  if (isInvalidCategory) return <RedirectTo href="/jobs" />;
  if (isInvalidLocation) return <RedirectTo href={`/jobs/category/${category}`} replace />;
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <section className="mt-14">
            ...
            <div className="flex flex-wrap gap-2">
              {locationSlugs.map(l => (
                <Link key={l.slug} href={`/jobs/category/${cat!.slug}/${l.slug}`}>
          ...
          <section className="mt-10">
            ...
            <div className="flex flex-wrap gap-2">
              {categories.filter(c => c.slug !== cat!.slug).map(c => (
                <Link key={c.slug} href={`/jobs/category/${c.slug}${loc ? "/" + loc.slug : ""}`}>
