...
const logoImage = '/assets/jobbyist-logo.jpeg';
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Link href="/?country=ZA" className="px-4 py-2 bg-card rounded-lg border hover:border-primary transition-colors">
                🇿🇦 South Africa
              </Link>
              <Link href="/?country=NG" className="px-4 py-2 bg-card rounded-lg border hover:border-primary transition-colors">
                🇳🇬 Nigeria
              </Link>
              <Link href="/?country=KE" className="px-4 py-2 bg-card rounded-lg border hover:border-primary transition-colors">
                🇰🇪 Kenya
              </Link>
            </div>
          </div>
